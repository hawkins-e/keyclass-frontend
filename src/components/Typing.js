...
// const random_setting = 100;
// // The text to use NB use \n not real life line breaks!
// const input_text = "How fast can you type?";
// // Where to fill up
// const target_setting = ("#output");
// // Launch that function!
// const type(input_text, target_setting, 0, time_setting, random_setting);
...
// const character_length = 31;
// const index = 0;
// const letters =  ("#input_text").val();
// const started = false;
// const current_string = letters.substring(index, index + character_length);
